...
{
    /**
     * @Route("/", name="app_dashboard_news_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_dashboard_news_new", methods={"GET", "POST"})
     */
    public function new(Request $request, NewsRepository $newsRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_dashboard_news_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="app_dashboard_news_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_dashboard_news_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_dashboard_news_delete", methods={"POST"})
     */
