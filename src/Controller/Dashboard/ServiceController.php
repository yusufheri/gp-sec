...
{
    /**
     * @Route("/", name="app_dashboard_service_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_dashboard_service_new", methods={"GET", "POST"})
     */
    public function new(Request $request, ServiceRepository $serviceRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_dashboard_service_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('dashboard/service/new.html.twig', [
            'service' => $service,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="app_dashboard_service_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_dashboard_service_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_dashboard_service_delete", methods={"POST"})
     */
